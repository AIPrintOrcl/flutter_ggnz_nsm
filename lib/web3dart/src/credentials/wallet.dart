...
class Wallet {
  ...
  factory Wallet.fromJson(String encoded, String password) {
    ...
    */
    ...
    final credentials = Web3PrivateKey(privateKey);
  ...
  final Web3PrivateKey privateKey;
  ...
  String toJson() {
    ...
    final map = {
      ...
      'id': uuid,
      'address': privateKey.address.hexEip55,
      'version': 3,
    };
...
class FilePath {
  ...
  Future<File> get _localFile async {
    ...
    print('$path/Keystore.json');
    return File('$path/Keystore.json');
  }

  Future<String> getKeystorePath() async {
    final path = await _localPath;
    return path + "/Keystore.json";
  }
}